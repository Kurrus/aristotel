<template>
  <main>
    <div class="courses-all" v-if="category && courses">
      <div class="section-frame">
        ...
        <div class="courses-all-frame">
          <div class="courses-category" v-if="category">
            ...
            <transition v-on:enter="enter" v-on:leave="leave">
              <div class="courses-category-list"  v-show="category_open">
                <div class="courses-category-item" v-for="item in category" :key="item.id">
                  ...
                  <transition v-on:enter="enter" v-on:leave="leave">
                    <ul v-if="item.children.length" v-show="item.is_open">
          ...
          <div class="courses-all-box" v-if="courses">
            <div class="courses-all-list">
              <CoursesCard v-for="item in courses.result" :key="item.id" :data="item" :finish="true"/>
            </div>
